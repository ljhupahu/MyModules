...
public final class Teacher {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Teacher.internal_static_tea_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Teacher.internal_static_tea_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Teacher.tea.class, Teacher.tea.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Teacher.tea)) {
        return super.equals(obj);
      }
      Teacher.tea other = (Teacher.tea) obj;
    ...
    public static Teacher.tea parseFrom(
    ...
    public static Teacher.tea parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Teacher.tea parseFrom(
    ...
    public static Teacher.tea parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Teacher.tea parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Teacher.tea parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Teacher.tea prototype) {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public Teacher.tea getDefaultInstanceForType() {
        return Teacher.tea.getDefaultInstance();
      }

      @java.lang.Override
      public Teacher.tea build() {
        Teacher.tea result = buildPartial();
      ...
      @java.lang.Override
      public Teacher.tea buildPartial() {
        Teacher.tea result = new Teacher.tea(this);
        result.id_ = id_;
        result.age_ = age_;
        result.name_ = name_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Teacher.tea) {
          return mergeFrom((Teacher.tea)other);
        } else {
      ...
      public Builder mergeFrom(Teacher.tea other) {
        if (other == Teacher.tea.getDefaultInstance()) return this;
        if (other.getId() != 0L) {
          setId(other.getId());
        }
        if (other.getAge() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Teacher.tea parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Teacher.tea) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final Teacher.tea DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Teacher.tea();
    }

    public static Teacher.tea getDefaultInstance() {
